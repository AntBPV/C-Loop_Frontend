...
export class Navbar {
  ...
  menus: MenuData = {
    explorar: [
      {
        label: 'Convenios',
        description: 'Consulta los convenios activos de tu institución.',
        icon: 'public/icons/convenios.svg',
      },
      {
        label: 'Empresas',
        description: 'Explora las empresas vinculadas al sistema.',
        icon: 'public/icons/empresas.svg',
      },
      {
        label: 'Estadísticas',
        description: 'Visualiza datos generales del sistema.',
        icon: 'public/icons/estadisticas.svg',
      },
    ],
    recursos: [
    ...
    desarrolladores: [
      {
        label: 'Quienes Somos',
        description: 'Conoce quien esta detras de C-Loop.',
        icon: 'icons/meet.svg',
      ...
      // { label: 'Documentación', description: 'Accede a la documentación técnica de la API.', icon: 'public/icons/docs.svg' },
      {
        ...
        icon: 'icons/repo.svg',
        externalUrl: 'https://github.com/AntBPV/C-Loop_Frontend',
      },
    ],
  };
